...
<c:if test="${!empty user }">
	...
	<!-- 在这里显示我的订单，请求OrderClientServlet的list方法 -->
	<!-- 这里并没有带上orderId，而是结账的时候返回了一个orderId -->
	<!-- 直接用webutils的getloginuser方法得到用户 的订单信息-->
	</span> <a href="OrderClientServlet?method=list">我的订单</a> 
